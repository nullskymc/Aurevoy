...
export const zh = {
  ...
  "kb.removeDir": "移除",
  "kb.embeddingTitle": "Embedding 配置",
  "kb.embeddingDesc": "配置 OpenAI 兼容的 Embedding API（Ollama、OpenAI、LiteLLM），用于向量语义检索。",
  "kb.embeddingEnabled": "已启用",
  "kb.embeddingDisabled": "未配置 — 仅关键词检索",
  "kb.dirExists": "目录已添加",
  "kb.addFailed": "添加目录失败：",
