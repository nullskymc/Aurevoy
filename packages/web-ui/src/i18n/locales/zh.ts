...
export const zh = {
  ...
  "inspector.piRuntime": "Pi Agent 运行时",
  "inspector.provider": "Provider",
  "inspector.thinking": "推理深度",
  "inspector.toolExecution": "工具执行",
  "inspector.autoMode": "自动模式",
  "inspector.commandExecution": "命令执行",
  "inspector.enabled": "已启用",
  "inspector.disabled": "已停用",
  ...
  "inspector.budget": "预算",
  "inspector.planProgress": "计划进度",
  "inspector.pendingApprovals": "待审批",
  ...
  // 右侧文件面板
  "rightPanel.panelLabel": "文件与产物面板",
  "rightPanel.title": "文件",
  "rightPanel.hide": "隐藏文件",
  "rightPanel.show": "显示文件",
  "rightPanel.workspace": "工作区",
  "rightPanel.artifacts": "对话产物",
  "rightPanel.noArtifacts": "暂无产物",
  "rightPanel.noOpenTabs": "未打开文件",
  "rightPanel.openFile": "打开文件",
  "rightPanel.newTab": "新建文件页签",
  "rightPanel.filterFiles": "筛选文件…",
  "rightPanel.tabs": "文件标签",
  "rightPanel.selectFile": "从文件树中选择文件",
  "rightPanel.loading": "加载中…",
  "rightPanel.refresh": "刷新文件树",
  "rightPanel.truncated": "结果已截断",
  "rightPanel.contentTruncated": "内容已按安全上限截断",
  "rightPanel.directoryPreviewUnsupported": "目录只能在文件树中浏览",
  "rightPanel.taskWorkspace": "任务工作区",
  "rightPanel.defaultWorkspace": "默认工作区",
  "rightPanel.runtimeStatus": "运行时状态",
  ...
  "settings.commandExecDesc": "启用后，Agent 才能请求执行命令；每条具体命令仍按当前 auto mode 策略处理，必要时只批准本次调用。",
  ...
  "settings.providerDesc": "选择 Agent 使用的 provider。保存后主任务和子代理都会使用该配置。",
