import type { AppIconProps } from "./props";

/**
 * Settings sidebar glyph set (20×20 stroke language).
 * Names match `SettingsIconName` in settings/types.
 */
...
/** @deprecated alias — use SettingsNavIcon */
export function SettingsNavLucideIcon(props: {
  name: SettingsNavIconName;
  size?: number;
  className?: string;
} & AppIconProps) {
  return <SettingsNavIcon name={props.name} size={props.size} className={props.className} />;
}
