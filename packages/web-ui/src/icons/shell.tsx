...
/** Shared stroke icons for app shell (sidebar / chrome). */

export function IconPlus(props: AppIconProps = {}) {
  return (
...
export function IconSkills(props: AppIconProps = {}) {
  return (
    <svg {...strokeIconAttrs(props)}>
...
/** Settings “sliders” variant (general prefs). */
export function IconSettings2(props: AppIconProps = {}) {
  return (
    <svg {...strokeIconAttrs({ size: 17, ...props, viewBox: "0 0 20 20" })}>
      <path d="M4 6h7M4 14h7M13 6h3M13 14h3" />
...
export function IconFolder(props: AppIconProps = {}) {
  return (
    <svg {...strokeIconAttrs(props)}>
...
export function IconFolderOpen(props: AppIconProps = {}) {
  return (
    <svg {...strokeIconAttrs(props)}>
      <path d="M2.2 5.2h3l1.1 1.2H13.5v6.3a1 1 0 01-1 1H3.2a1 1 0 01-1-1V5.2z" />
      <path d="M2.4 11.8 4.1 7.4h9.2l-1.5 4.4" />
    </svg>
  );
}

export function IconChat(props: AppIconProps = {}) {
  return (
    <svg {...strokeIconAttrs(props)}>
...
export function IconTrash(props: AppIconProps = {}) {
  return (
...
export function IconChevron({ open, ...props }: AppIconProps & { open?: boolean } = {}) {
  return (
    <svg
      {...strokeIconAttrs({ size: 12, ...props })}
      className={[props.className, "shell-chevron", open ? "is-open" : ""].filter(Boolean).join(" ")}
    >
